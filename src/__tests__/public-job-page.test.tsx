...
import { appRender, render, screen } from '@/testing/test-utils'
...
describe('Public Job Page', () => {
  ...
  test('should render the job details', async () => {
  ...
  test('should render the not found message if the data does not exist', async () => {
