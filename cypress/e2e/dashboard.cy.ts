...
describe('dashboard', () => {
  ...
  it('should navigate to and visit the job details page', () => {
    ...
    cy.findByRole('heading', { name: job.position }).should('exist')
  ...
  it('should create a new job', () => {
    ...
    cy.findByRole('link', { name: /create job/i }).click()
    ...
    cy.findByRole('textbox', { name: /position/i }).type(jobData.position)
    cy.findByRole('textbox', { name: /department/i }).type(jobData.department)
    cy.findByRole('textbox', { name: /location/i }).type(jobData.location)
    cy.findByRole('textbox', { name: /info/i }).type(jobData.info)
